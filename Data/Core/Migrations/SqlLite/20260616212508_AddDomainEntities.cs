        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DbmsName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    DbmsSystemName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ...
                    EnvUserKey = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    EnvPasswordKey = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    EnvDatabaseKey = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ExtraEnvConfig = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    DefaultDatabase = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    DefaultUsername = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    DefaultPassword = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StrictColumnOrder = table.Column<bool>(type: "INTEGER", nullable: false),
                    StrictRowOrder = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TopicName = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    DbmsId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    DbmsId = table.Column<Guid>(type: "TEXT", nullable: false),
                    DbName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PhysicalTypeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ParameterKey = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    InputType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ...
                    SqlFragment = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    IsRequired = table.Column<bool>(type: "INTEGER", nullable: false),
                    ValuePrefix = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ValueSuffix = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    Separator = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TargetDbId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SqlQueryId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TaskName = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
                    TaskText = table.Column<string>(type: "TEXT", nullable: false),
                    DifficultyLevel = table.Column<short>(type: "INTEGER", nullable: false),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    MetaTableId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaTableId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PhysicalTypeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    AttributeName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartAttempt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    EndAttempt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    MetaAttributeId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttributeParameterValues_ParameterDefinitions_ParameterDefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    DataRecordId = table.Column<Guid>(type: "TEXT", nullable: false),
                    MetaAttributeId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    RelationshipName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    SourceAttributeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TargetAttributeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    DeleteRule = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    UpdateRule = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    CreatedById = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    UpdatedById = table.Column<Guid>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
